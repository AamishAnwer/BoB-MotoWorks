      ...
      <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2">
            <button
              type="button"
              className="text-white bg-black hover:bg-lime-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Rent A Car
            </button>
          ...
          >
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-12 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <a
                href="#"
                className="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-lime-600 md:p-0 md:dark:text-blue-500 text-xl"
                aria-current="page"
              >
                Home
              </a>
...
------------------------------------------------------------------------------------------------------ cardssssssssss ----------------------------------------------------------------------------------------------------------------- */}
      <section className="bg-white ">
        <div className="container px-6 py-10 mx-auto">
          <h1 className="text-2xl font-semibold text-center text-lime-600 capitalize lg:text-3xl dark:text-cyan-500">
            Special Eid Offer!
          </h1>
      ...
      <div className="bg-white py-20 sm:py-32">
        <h2 className="max-w-4xl py-10 mx-auto text-4xl font-semibold tracking-tight text-gray-800 xl:text-4xl dark:text-gray-800 text-center">
          ...
          <span className="text-lime-600 ">
            {" "}
            Top Most Trusted Companies We Have
          </span>
        </h2>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
            ...
            <motion.img
              ...
              transition={{ duration: 0.5 }}
              className="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
              src="https://res.cloudinary.com/dcpte972l/image/upload/v1687613497/ford-logo-2017-download_puphgu.png"
              alt="Transistor"
              width={158}
              height={48}
            />
...
------------------------------------------------------------------------------------------------------------------------ Cards -------------------------------------------------------------------------------------------------------------- */}
      <section className="bg-gray-100">
        <div className="container flex flex-col items-center px-4 py-12 mx-auto text-center">
          <h2 className="max-w-2xl mx-auto text-2xl font-semibold tracking-tight text-gray-800 xl:text-3xl dark:text-gray-800">
            Services You Need{" "}
            <span className="text-lime-600">at MotoWorks</span>
          </h2>
          ...
          <div className="grid gap-8 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
            <div className="bg-black bg-opacity-5 rounded-xl shadow-lg mx-4 my-6 px-8 py-6 max-w-sm transform hover:scale-105 transition-transform duration-300">
              <div className="relative overflow-hidden">
                ...
                <div className="flex justify-center items-center h-20 w-20 rounded-full mx-auto">
                  <img
                    src="https://res.cloudinary.com/dcpte972l/image/upload/v1687614677/muscular-car-service-worker-repairing-vehicle_en3yrd.jpg"
                    className="w-32"
                    alt="Logo"
                  />
                </div>
            ...
            <div className="bg-black bg-opacity-5 rounded-xl shadow-lg mx-4 my-6 px-8 py-6 max-w-sm transform hover:scale-105 transition-transform duration-300">
              <div className="relative overflow-hidden">
                ...
                <div className="flex justify-center items-center h-20 w-20 rounded-full mx-auto">
                  <img
                    src="https://res.cloudinary.com/dcpte972l/image/upload/v1687614659/car-mechanic-changing-wheels-car_yhuxlr.jpg"
                    className="w-32"
                    alt="Logo"
                  />
                </div>
            ...
            <div className="bg-black bg-opacity-5 rounded-xl shadow-lg mx-4 my-6 px-8 py-6 max-w-sm transform hover:scale-105 transition-transform duration-300">
              <div className="relative overflow-hidden">
                ...
                <div className="flex justify-center items-center h-20 w-20 rounded-full mx-auto">
                  <img
                    src="https://res.cloudinary.com/dcpte972l/image/upload/v1687615744/mechanic-hand-checking-fixing-broken-car-car-service-garage_1_oldrbj.jpg"
                    className="w-32"
                    alt="Logo"
                  />
                </div>
            ...
            <div className="bg-black bg-opacity-5 rounded-xl shadow-lg mx-4 my-6 px-8 py-6 max-w-sm transform hover:scale-105 transition-transform duration-300">
              <div className="relative overflow-hidden">
                ...
                <div className="flex justify-center items-center h-20 w-20 rounded-full mx-auto">
                  <img
                    src="https://res.cloudinary.com/dcpte972l/image/upload/v1687615743/hand-car-mechanic-with-wrench-auto-repair-garage_esiieb.jpg"
                    className="w-32"
                    alt="Logo"
                  />
                </div>
            ...
            <div className="bg-black bg-opacity-5 rounded-xl shadow-lg mx-4 my-6 px-8 py-6 max-w-sm transform hover:scale-105 transition-transform duration-300">
              <div className="relative overflow-hidden">
                ...
                <div className="flex justify-center items-center h-20 w-20 rounded-full mx-auto">
                  <img
                    src="https://res.cloudinary.com/dcpte972l/image/upload/v1687615734/gun-with-paint-hands-man-paint-car_knbhk2.jpg"
                    className="w-32"
                    alt="Logo"
                  />
                </div>
            ...
            <div className="bg-black bg-opacity-5 rounded-xl shadow-lg mx-4 my-6 px-8 py-6 max-w-sm transform hover:scale-105 transition-transform duration-300">
              <div className="relative overflow-hidden">
                ...
                <div className="flex justify-center items-center h-20 w-20 rounded-full mx-auto">
                  <img
                    src="https://res.cloudinary.com/dcpte972l/image/upload/v1687616086/Screenshot_2023-06-24_181416_jiwgzw.png"
                    className="w-32"
                    alt="Logo"
                  />
                </div>
            ...
            <div className="bg-black bg-opacity-5 rounded-xl shadow-lg mx-4 my-6 px-8 py-6 max-w-sm transform hover:scale-105 transition-transform duration-300">
              <div className="relative overflow-hidden">
                ...
                <div className="flex justify-center items-center h-20 w-20 rounded-full mx-auto">
                  <img
                    src="https://res.cloudinary.com/dcpte972l/image/upload/v1687616946/download_tzt6cc.jpg"
                    className="w-32"
                    alt="Logo"
                  />
                </div>
            ...
            <div className="bg-black bg-opacity-5 rounded-xl shadow-lg mx-4 my-6 px-8 py-6 max-w-sm transform hover:scale-105 transition-transform duration-300">
              <div className="relative overflow-hidden">
                ...
                <div className="flex justify-center items-center h-20 w-20 rounded-full mx-auto">
                  <img
                    src="https://res.cloudinary.com/dcpte972l/image/upload/v1687615633/13123_fvre3f.jpg"
                    className="w-32"
                    alt="Logo"
                  />
                </div>
          ...
          <div className="grid grid-cols-1 gap-2 mt-8 xl:mt-12 xl:gap-6 md:grid-cols-2 xl:grid-cols-4">
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
                <h1 className="text-lg font-bold text-white">AED 150</h1>
      ...
      <section className="bg-gray-100 dark:bg-gray-900">
        <div className="text-center">
          <h2 className="max-w-2xl mx-auto text-2xl font-semibold tracking-tight text-lime-600 xl:text-3xl dark:text-gray-800">
            CONTACT US
          </h2>
        </div>
            ...
            <div className="lg:max-w-lg">
              ...
              <div className="mt-8 space-y-5">
                <p className="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                  ...
                  <span className="mx-2">Call Us On +971568970161</span>
                </p>
                ...
                <p className="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                  ...
                  <span className="mx-2">Mail Us On shahrom@bob.ae</span>
                </p>
                ...
                <p className="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                  ...
                  <span className="mx-2">Whats App On +971568970161</span>
                </p>
              </div>
            </div>
        ...
        <div className="relative flex">
          ...
          <div className="container flex flex-col justify-center w-full min-h-screen px-6 py-10 mx-auto lg:absolute lg:inset-x-0">
            <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">
              What our <span className="text-lime-600">customers</span> <br />{" "}
              are saying
            </h1>
            ...
            <div className="mt-10 lg:mt-20 lg:flex lg:items-center">
              ...
              <div className="mt-8 lg:px-10 lg:mt-0">
                ...
                <p className="max-w-lg mt-6 text-gray-500 dark:text-gray-400">
                  “ I recently used BOB MotoWorks for both car rental and car
                  repair services, and I must say, I was thoroughly impressed
                  with their professionalism and quality of service. The website
                  is user-friendly, making it easy to navigate and find the
                  services I needed. The car rental process was seamless, and
                  the car was in excellent condition, making my trip enjoyable
                  and stress-free. ”
                </p>
      ...
      <footer className="bg-black dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div className="mb-6 md:mb-0">
              <a href="#" className="flex items-center">
                <img
                  ...
                  alt="FlowBite Logo"
                />
                <span className="self-center text-2xl font-semibold whitespace-nowrap text-lime-600 dark:text-white">
                  BOB MOTOWORKS
                </span>
              </a>
            </div>
          ...
          <hr className="my-6 text-lime-600 sm:mx-auto text-lime-600 lg:my-8" />
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a
                href="#"
                className="text-lime-600 hover:text-gray-100 dark:hover:text-white"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
